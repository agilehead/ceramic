(function() {
    ...
    */
    ...
    var SchemaManager = function(options) {
        ...
        if (options) {
            if (options.fn) {
                /*
                    mustConstruct and getDynamicEntitySchema can also be substituted by deriving from SchemaManager
                */
    ...
    */
    ...
    SchemaManager.prototype.validateProperty = function*(obj, value, propertyName, propertyDef) {
        return yield* this.validator.validateProperty(obj, value, propertyName, propertyDef);
	};
